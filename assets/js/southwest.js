window.onload = function () {
  var world = Snap.load("https://joshcarr.co.uk/assets/svg/southwest.svg", onSVGLoaded);
  let ticking = false;
...
function drawMap(scroll_pos, limit) {
  ...
  try {
    ...
    subPat1.attr({ "id": "scrolled", "stroke": "blue", "stroke-width": "3", "fill": "none", "line-cap": "round" });
    var y = Math.floor(120 + 200 * (scroll_pos / parseFloat(limit)));
    s.attr({ viewBox: "0," + y + ",600,150" });
  } catch (error) {
